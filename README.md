...
Go to GCP on secret manager, view the secret named url_shortener_password and copy the database password to vault kave-tech-services/show/url-shortener ->  DATABASE_PASSWORD key.
