...
interface Props extends BoxProps {
  color?: "primary" | "purple" | "gray" | "blue" | "red";
  disabled?: boolean;
...
export const Button = styled(Flex)<Props>`
  ...
  line-height: 1;
  word-break: keep-all;
  color: ${switchProp(prop("color", "primary"), {
    blue: "white",
    red: "white",
    purple: "white",
    gray: "#444",
  ...
  background: ${switchProp(prop("color", "primary"), {
    ...
    primary: "linear-gradient(90.01deg, #939393 -12.88%, #696969 -0.7%, #424242 26.93%, #101010 53.62%, #000000 98.81%)"
  })};
  box-shadow: ${switchProp(prop("color", "primary"), {
    ...
    primary: "-5px 5px 6px 0px #00000033"
  })};
  border: none;
  border-radius: 100px;
